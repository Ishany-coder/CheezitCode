...
public class CubicSpline extends MainSpline{
    public double dx, dy;
    public CubicSpline(Odometery odo, DrivetrainSquIDController squid, CoaxialDrive drive) {
        super(odo, squid, drive);
    }
    public void MoveSplineWithSplineHeading(List<Pose2d> path) {
    ...
    public List<Pose2d> makeCubicSpline(Pose2d startPose, List<Translation2d> interiorPoints, Pose2d endPose) {
        ...
        for (int sample = 0; sample <= numSamples; sample++) {
            ...
            dx = (xValues[segmentIndex + 1] - xValues[segmentIndex]) / segmentLength
            ...
            dy = (yValues[segmentIndex + 1] - yValues[segmentIndex]) / segmentLength
