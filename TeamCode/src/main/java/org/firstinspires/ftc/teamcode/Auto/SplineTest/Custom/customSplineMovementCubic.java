...
public class customSplineMovementCubic extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(opModeIsActive()){
            path = CoaxialDrive.makeCubicSpline(startPose, midPoints, endPose); // get a list of points in path
            CoaxialDrive.MoveSplinePurePursuitWithSquID(startPose, path, squid, drive);
        }
    }
}
